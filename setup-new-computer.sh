...
options[1]="PhpStorm";              devtoolchoices[1]=""
options[2]="Pycharm";               devtoolchoices[2]=""
options[3]="Postman";               devtoolchoices[3]=""
options[4]="Insomnia";              devtoolchoices[4]=""
options[5]="iTerm2";                devtoolchoices[5]=""
options[6]="Keybase";               devtoolchoices[6]=""
options[7]="Sequel Ace";            devtoolchoices[7]=""
...
cat << "EOT"
    ...
    NOTE:
    You can exit the script at any time by pressing CONTROL+C a bunch
EOT
}
...
printHeading "Installing Brew Packages"
    ...
    printStep "trash"                         "brew install trash"
    printStep "svn"                         "brew install svn"
    printStep "mackup"                         "brew install mackup"
    printStep "node"                         "brew install node"
printDivider
...
printHeading "Installing Applications"
    ...
    if [[ -d "/Applications/Google Chrome.app" ]]; then
        ...
        printStep "Google Chrome"               "brew install --appdir="/Applications" --cask google-chrome"
    fi
    ...
    if [[ -d "/Applications/Docker.app" ]]; then
        ...
        printStep "Docker for Mac"              "brew install --appdir="/Applications" --cask docker"
    fi
    ...
    if [[ -d "/Applications/Slack.app" ]]; then
        ...
        printStep "Slack"                     "brew install --appdir="/Applications" --cask slack"
    fi

    
    if [[ -d "/Applications/Fig.app" ]]; then
        printDivider
        echo "✔ Fig already installed. Skipping"
    else
        printStep "Fig"                     "brew install --appdir="/Applications" --cask fig"
    fi
    ...
    echo "Installing other apps with Cask..."
    brew install --appdir="/Applications" ${otherapps[@]}

    # Install Visual Studio Code
    if [[ "${devtoolchoices[0]}" == "+" ]]; then
        printStep "Visual Studio Code"      "brew install --appdir="/Applications" --cask visual-studio-code"
    fi
    # Install PhpStorm
    if [[ "${devtoolchoices[1]}" == "+" ]]; then
        printStep "PhpStorm"       "brew install --appdir="/Applications" --cask phpstorm"
    fi
    # Install PyCharm
    if [[ "${devtoolchoices[2]}" == "+" ]]; then
        printStep "PyCharm"                 "brew install --appdir="/Applications" --cask pycharm"
    fi
    # Install Postman
    if [[ "${devtoolchoices[3]}" == "+" ]]; then
        printStep "Postman"                  "brew install --appdir="/Applications" --cask postman"
    fi
    # Install WebStorm
    if [[ "${devtoolchoices[4]}" == "+" ]]; then
        printStep "Insomnia"                "brew install --appdir="/Applications" --cask insomnia"
    fi
    # Install iTerm2
    if [[ "${devtoolchoices[5]}" == "+" ]]; then
        printStep "iTerm2"            "brew install --appdir="/Applications" --cask iterm2"
    fi
    # Install Keybase
    if [[ "${devtoolchoices[6]}" == "+" ]]; then
        printStep "Keybase"                  "brew install --appdir="/Applications" --cask keybase"
    fi
    # Install Sequel Ace
    if [[ "${devtoolchoices[6]}" == "+" ]]; then
        printStep "Sequel Ace"                  "brew install --appdir="/Applications" --cask sequel-ace"
    fi
printDivider
